<%@ Page Title="" Language="C#" MasterPageFile="~/master_page(web form).Master" AutoEventWireup="true" CodeBehind="user_profile.aspx.cs" Inherits="OOM_Project_1.user_profile" %>
    ...
    <div class ="container-fluid">
                                ...
                                <div class ="row">
                                    <div class ="col">
                                        <center>
                                            ...
                                            <asp:Label CssClass="badge rounded-pill bg-info" ID="Label1" runat="server" Text="Your status"></asp:Label>
                                        </center>
                                    </div>
                                </div>
                                <div class ="row">
                        ...
                        <div class ="row">
                            <div class ="col-md-4">
                                ...
                                <asp:TextBox placeholder="ID" CssClass="form-control" ID="TextBox8" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>
                            <div class ="col-md-4">
                                <label class="form-label">Password</label>
                                <asp:TextBox placeholder="Password" CssClass="form-control" ID="TextBox9" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>
                            <div class ="col-md-4">
                                <label class="form-label">New Password</label>
                                <asp:TextBox placeholder="New Password" CssClass="form-control" ID="TextBox10" runat="server" TextMode="Password" ></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class ="row">
                            <div class ="col">
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    <asp:Button class ="btn btn-info" ID="Button1" runat="server" Text="Update" OnClick="Button1_Click" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class ="col-md-7">
                               ...
                               <div class ="row">
                                    <div class ="col">
                                        <asp:GridView CssClass="table table-bordered table-striped" ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound1">
                                        </asp:GridView>
                                    </div>
                                </div>
